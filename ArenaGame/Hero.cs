...
namespace ArenaGame
{
    public abstract class Hero : IHero
    {
        ...
        public virtual double Heal(){
            if(!(Weapon is MagicStaff)) return 0;
            double newHealth = Weapon.Heal(Health);
        ...
        public virtual double BoostAttack(){
            if(!(Weapon is Gauntlet)) return 0;
            return Weapon.BoostAttack();
        }
